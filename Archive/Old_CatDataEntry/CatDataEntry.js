...
function addCat() {
    ...
    let catPose = parsePose(catPageInfo, catName)
...
//oops dataArray doesn't have pose in it rn so this is nonfunctional, welp fix later
function parsePose(dataArray, name) {
    console.log(dataArray)
    let line = simpleLineNumberSearch(dataArray, name, 0) -1
    console.log(line)
    let pose = dataArray[line].split(" ")[0]
    console.log(pose)
